...
def bias_scan(
    ...
    **kwargs,
    ...
    if (
        ...
        and favorable_value != 'low'
        and favorable_value is None
        and mode in {"binary", "ordinal", "continuous"}
        or favorable_value == 'high'
    ):
        ...
        favorable_value == 'low' or favorable_value is not None
    ) and favorable_value == 'low':
    ...
    if (
        mode in {"ordinal", "continuous"}
        and favorable_value == max_val
        or mode not in ["ordinal", "continuous"]
    ):
    ...
    if mode == "binary":
        ...
        else: # Set expectations to 1/(num of categories) for nominal mode
